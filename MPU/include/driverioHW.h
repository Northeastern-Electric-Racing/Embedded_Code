...
typedef enum ButtonState_t { NOT_PRESSED, DEBOUNCING, PRESSED } ButtonState_t;
...
public:
  ...
  /**
   * @brief Checks the state of the passed button pin and starts debounce if
   * going from 0->1
  ...
  /**
   * @brief Returns if the button has successfully passed the debounce AND has
   * not been read yet
   *
   * @return true
   * @return false

...
void setCANLineOK() { canTest_wait.startTimer(2000); }
...
void writeFaultLatch(FaultStatus_t status) {
  // The logic is flipped because of how the enum is set up to allow for
  // exceptions if fault (FAULT = 1 = true, NOT FAULTED = 0 = False)

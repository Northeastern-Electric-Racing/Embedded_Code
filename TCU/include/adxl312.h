 ...
 * --Datasheet
 * https://wiki.analog.com/resources/quick-start/adxl312_quick_start_guide
 * --Used for implementation
 */
#define ADXL312_I2C_ADDR                                                       \
  0x53 // This depends on how the address pin is wired, 0x1D with Vcc and 0x53
       // with Gnd
#define ADXL312_DEVID_REG 0x00
#define ADXL312_DEVID 0xE5
#define ADXL312_POWER_CTRL_REG 0x2D
#define ADXL312_POWER_CTRL_MEASURECMD                                          \
  0x08 // This tells the accelerometer to read the value, might need to change
       // it the sleep mode if not in use
...
public:
  /**
   * @brief Construct a new ADXL312 object and verify and configure the

/**
 * @file rtc.h
 * @brief Defines timing utility functions for the Nerduino real time clock
 * (RTC)
 *
 */
...
typedef enum { RTC_SUCCESS = 0, RTC_NOT_STARTED = 1 } RTC_STATUS;
...
/**
 * @brief Gets the current RTC time as a string in the format

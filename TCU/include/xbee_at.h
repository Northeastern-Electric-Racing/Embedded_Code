 ...
 *
 * @details XBees have two device modes, API and AT. This file defines AT mode,
 * which acts as a raw serial bridge between the two communicating modules. API
 * mode, on the other hand, defines packet structures for more functionality
 * (and more complexity). See the teensy 4.1 docs for an impelementation of API
 * mode.
 *
 */
 ...
 * @return XBEE_STATUS
 */
XBEE_STATUS XBeeReceiveMessage(uint8_t *buf, uint32_t maxLen,
